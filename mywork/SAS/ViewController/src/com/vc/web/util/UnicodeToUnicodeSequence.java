...
public class UnicodeToUnicodeSequence {
    ...
    public static String convert(final String unicodeString) {
        ...
        for (int i = 0; i < unicodeLowerCase.length; i++) {
            str = 
str.replaceAll(unicodeLowerCase[i], unicodeSequenceLowerCase[i]);
        }

        for (int i = 0; i < unicodeUpperCase.length; i++) {
            str = 
str.replaceAll(unicodeUpperCase[i], unicodeSequenceUpperCase[i]);
        }
    ...
    public static String convertFile(final String inputFileName, 
